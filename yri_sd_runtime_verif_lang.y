...
%token	<opt_val>	STAR_SIGN_TOK
%token	<opt_val>	SHARP_SIGN_TOK
...
%type	<opt_val>	prog_operation_value
...
inside_algebra_set_specification : IN_POST_NOP_TOK																			{a_spec_stmt_ROOT->
																 ...
																 | in_spec 
																 		LEFT_PARENTHESIS_TOK 
																 			prog_operation_value COMA_TOK db_table DOT_TOK db_column 
...
event_call : STRING_TOK 																																{ a_spec_stmt_ROOT->process_event_call($1->c_str()); }
					 ;
prog_operation_value : ALPHA_NUM_TOK
										 | prog_operation_value STAR_SIGN_TOK ALPHA_NUM_TOK
										 | prog_operation_value SHARP_SIGN_TOK ALPHA_NUM_TOK
										 | prog_operation_value DOT_TOK ALPHA_NUM_TOK
										 ;
